...
import {
  ...
  rgbToHex,
  rgbToHsl,
} from "@/helpers/color-convert";
import { cn } from "@/lib/utils";
import { ArrowDown, PipetteIcon } from "lucide-react";
    ...
    <div className={cn(className)}>
      <div className="flex items-center gap-4">
        <Popover onOpenChange={handlePopoverChange}>
          <PopoverTrigger>
            <div className="py-2 px-3 border rounded-md border-zinc-800 flex items-center gap-2 text-zinc-300 cursor-pointer">
              <Button
                className="border-border h-7 w-26 border shadow-none relative overflow-hidden rounded-none cursor-pointer"
                size={"icon"}
